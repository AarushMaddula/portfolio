      ...
      <div className="flex flex-col-reverse lg:flex-row items-center gap-16 col-span-1 lg:col-span-2">
        <div className="">
          ...
          <p className="text-muted">
            I’m Aarush Maddula, a developer who loves turning ideas into things
            you can actually use. I’ve built everything from Java games (3D Tak,
            Othello AI, and a full-featured chess app) to iOS apps, web projects
            with Tailwind/Next.js, and even hardware experiments like modifying
            a 3D printer into a plotter. 
            <br/>
            <br/>
            I enjoy building tools that are fast,
            clean, and purposeful—whether that means writing efficient code,
            designing intuitive interfaces, or teaching others to code (I’ve
            volunteered at tech camps and help classmates whenever I can).
            <br/>
            <br/>
            Outside of programming, you’ll probably find me at the gym, on my
            bike, or deep in some new project that I swore I wouldn’t start… yet
            somehow did.
          </p>
        </div>
